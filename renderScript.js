import {currentScript, numScripts, scripts, selectedSprite} from './index.js';
import {reRender} from "./renderer.js";

export const scriptTemplate = scriptName => (
`
export class ${scriptName} extends ee.JSBehaviour {
    constructor(){super()}
...
export const renderScripts = (divID) => {
    ...
    s.html(`
        <div style="width: 100%; height: 100%;">
                ...
                ${mapScripts((name, script) => `
                    <button 
                        ...
                        style="
                            ...
                            outline: none;
                            padding: 4px;
                            background-color: ${name === currentScript ? 'var(--input-opposite-bg)':'var(--input-bg)'}
                        "
                        onMouseOver="this.style.backgroundColor='var(--input-hover-bg)'"
                        onMouseOut="this.style.backgroundColor='${name === currentScript ? 'var(--input-opposite-bg)':'var(--input-bg)'}'" 
                    >
                        ${name}.js
                    </button>
                `).join('')}
            ...
            <div id="script-editor" style="height: calc(100vh - 190px);">
