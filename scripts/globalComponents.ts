...
/**
 * @param data - data from the backend as a json
 * @param canDelete - does this user have the required access to delete this comment
 * @param options - should the little dots at the end of the comment show
 * @return the HTML
 */
export const comment = (data: commentData, canDelete =false, options=true) => `
